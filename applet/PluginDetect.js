...
;
j.NOTF.SetupAppletQuery();
if(typeof f=="function"){
j.funcs[j.funcs.length]=f;
}
;
};
...
;
var e,c=t.C[_5e][0];
var _60=c&&c.firstChild?c.firstChild:null;
try{
if(_60&&$.isIE&&!_5b[0]){
if(_60.readyState==4){
}else{
if($.IEver>=t.minIEver&&!_60.object){
}else{
t.installed=-0.5;
}
}
...
if(t.installed==-0.5||t.installed==0.5){
t.NOTF.SetupAppletQuery();
}
;
...
;
var $=PluginDetect,n=this;
if(n.EventJavaReady===true){
}else{
n.EventJavaReady=true;
if(typeof setInterval!="undefined"){
n.javaInterval=setInterval(n.onIntervalQuery,250);
}
$.funcs[0]=n.winOnLoadQuery;
$.onWindowLoaded(0);
}
},winOnLoadQuery:function(){
var j=PluginDetect.java,n=j.NOTF;
if(j.installed==-0.5||j.installed==0.5){
var T=n.AppletQuery();
n.queryCleanup(T[0],T[1]);
}
...
var j=PluginDetect.java,x,Z=[null,null];
for(x=0;x<2;x++){
Z=j.query1Applet(x);
if(Z[0]){
return Z;
...
return Z;
},queryCleanup:function(_6c,_6d){
var $=PluginDetect,j=$.java,x,n=j.NOTF;
j.installed=_6c!=null?1:(j.installed==0.5?0:-1);
j.getVersionDone=1;
if(_6c!=null){
j.setVersion(_6c);
}
if(n.javaInterval){
clearInterval(n.javaInterval);
}
for(x=0;x<j.funcs.length;x++){
if(typeof j.funcs[x]=="function"){
j.funcs[x]();
}
}
;
