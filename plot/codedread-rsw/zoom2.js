    ...
    function init() {
        ...
        var handle = document.getElementById( "svgsvg" );
	//	handle.appendChild( make( 'g', { "id":"figure" } ) );
	//	return document.getElementById( "figure" );
	//	handle.appendChild( make ('rect', { "id":"zoomrect", "transform":"matrix(1,0,0,1,0,0)", "dragx":"0", "dragy":"0", "x":"0", "y":"0", "width":"1", "height":"1", "opacity":"1.0", "fill-opacity":"0.5", "fill":"gray", "stroke":"black", "stroke-width":"10" } ) );

        var zoomrect = document.getElementById("zoomrect");
        var axesbox = document.getElementById("axesbox");
